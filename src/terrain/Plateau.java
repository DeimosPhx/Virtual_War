...
public class Plateau extends JPanel{
	...
	public boolean deplacerTest(Joueur j,Robot rob,Direction direc){
		 ...
		 * coordonnees unite: this.grille[cord_unit.getAbscisse()][cord_unit.getOrdonnee()]
	...
	public boolean nestPasUnObstacleOuUneBase(Coordonnees coordonnees){
		if(this.getGrille()[coordonnees.getAbscisse()][coordonnees.getOrdonnee()] instanceof Obstacle || this.getGrille()[coordonnees.getAbscisse()][coordonnees.getOrdonnee()] instanceof Base){
			return false;
		}
		return true;
	}
	
	public boolean autoriser(Coordonnees coordonnees){
		return this.estDans(coordonnees) && this.nestPasUnObstacleOuUneBase(coordonnees);
	}
