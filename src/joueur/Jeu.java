...
public class Jeu extends Application{
	...
	public void setReglage(int tauxObstacle,boolean joueur1EstHumain,boolean joueur2EstHumain,int nbCharjoueur1,int nbCharJ2,int nbTireurjoueur1,int nbTireurJ2,int nbPiegeurjoueur1,int nbPiegeurJ2){
		...
		if(joueur1EstHumain){
			...
			joueur1 = new IARandom(1,B1,vuejoueur1);
		}
		if(joueur2EstHumain){
			joueur2 = new Joueur(2,B2,vueJ2);
		}
		else{
			joueur2 = new IARandom(2,B2,vueJ2);
		}
	...
	private void finDuTour(Stage stage){
	...
	public void start(Stage stage) throws Exception {
		...
		stage.show();
		draw(gcJeu);
		if(!joueur1EstHumain && tourjoueur1){
			System.out.println("j1 ia");
			joueur1.action(joueur1.selecUnite(),plateau);
			finDuTour(stage);
		}
		else if(!joueur2EstHumain && !tourjoueur1){
			System.out.println("j2 ia");
			joueur2.action(joueur2.selecUnite(), plateau);
			finDuTour(stage);
		}
		else{
